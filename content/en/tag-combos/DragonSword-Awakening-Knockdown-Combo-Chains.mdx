...
| Hero | Knockdown Tool | Best Partner |
|------|---------------|--------------|
| Kalien | Earth Shatter Signal Skill (AoE shockwave) | Lute (chain KD on multiple enemies) |
| Dana | Leg Sweep skill (guaranteed KD on small enemies) | Logan (backup KD source) |
| Veronica | Snap Trap (preemptive KD trigger) | Castella (follow-up burst) |
| Logan | Shield bash combo finisher (100% KD on 3rd hit) | Johnny (punish KD with Executioner's Shot) |
...
| Chain | Heroes | Total Damage | Notes |
|-------|--------|-------------|-------|
| Lute → Johnny → Castella | Lute + Johnny + Castella | Highest burst (3 Signal Skills) | Gold standard: KD → punish → barrage |
| Lute → Roxy → Castella | Lute + Roxy + Castella | High sustained (extended KD window) | Roxy Time Loop adds 1.5s to KD |
| Lute → Dana → Logan | Lute + Dana + Logan | Moderate (F2P friendly) | Multiple KD sources, Logan tanks |
...
| Combo | Single Target | AoE | Setup Time |
|-------|--------------|-----|------------|
...
| Kalien Earth Shatter opener | High (AoE shockwave) | Very High (multi-enemy KD) | Fast (single Signal Skill) |
